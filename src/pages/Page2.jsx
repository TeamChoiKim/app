    ...
    return (
        ...
        <h1 className="display-1 text-center">사용자 정보</h1>
            ...
            <div className="p-2 flex-fill d-grid">
                <button className="btn btn-primary" onClick={onclickp3}>수정</button>
            </div>
            <div className="p-2 flex-fill d-grid">
                <button className="btn btn-primary" onClick={onclickmain}>삭제</button>
            </div>
            <div className="p-2 flex-fill d-grid">
                <button className="btn btn-primary" onClick={onclickmain}>취소</button>
            </div>
            </div>
        </div>
    )
